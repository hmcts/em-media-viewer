...
const IDAM_SECRET = aksVaultConfig.secrets ? aksVaultConfig.secrets['em-showcase']['idam-client-secret'] : undefined;
const S2S_KEY = aksVaultConfig.secrets ? aksVaultConfig.secrets['em-showcase']['microservicekey-ccd-gw'] : undefined;
